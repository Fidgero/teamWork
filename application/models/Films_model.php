<?php
	...
	class Films_model extends CI_Model {
		...
		public function setMovies($slug, $name, $descriptions, $year, $rating, $poster, $player_code, $direction, $add_date, $category_id) {
			$date = array(
				'slug' => $slug,
				'name' => $name,
		...
		public function updateMovies$slug, $name, $descriptions, $year, $rating, $poster, $player_code, $direction, $add_date, $category_id) {
			$date = array(
				'slug' => $slug,
				'name' => $name,
				'descriptions' => $descriptions,
		...
		public function deleteMovies($slug) {
			return $this->db->delete(array('slug' => $slug));
		}
